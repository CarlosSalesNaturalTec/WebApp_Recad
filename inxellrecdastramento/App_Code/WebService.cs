...
/// </summary>
[WebService(Namespace = "http://inxellrecadastramento.azurewebsites.net/")]
...
public class ConexaoBancoSQL
{
    ...
    {
        // <!--*******Customização*******-->
        stringconnection1 = "Server=tcp:serverrecadastramento.database.windows.net,1433;Initial Catalog=dbrecadastramento;Persist Security Info=False;User ID=admserver;Password=a123456@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        try
        {
