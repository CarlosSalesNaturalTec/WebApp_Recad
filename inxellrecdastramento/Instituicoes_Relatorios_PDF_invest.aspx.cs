...
public partial class Instituicoes_Relatorios_PDF_invest : System.Web.UI.Page
{
    ...
    private void MontaPDF()
    {
        ...
        txtAux = "Por Investimento: " + RelFiltro;
       ...
       if (colunas == 3)
        {
            cell = new PdfPCell(new Phrase("Investimento", fontTabelaHeader)); table.AddCell(cell);
        }
        #endregion
